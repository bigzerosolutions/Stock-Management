...
/*************************************** Add to Company Bill table ************************************/

app.post('/addCompBill', function(req , res) 
{
  //console.log(req.body);
  var ddb = createDBConnection();
  var InvoiceDate =req.body.InvoiceDate.toString();
  var InvoiceAmountPaid =req.body.InvoiceAmountPaid.toString();
  var params = 
  {
    Item: 
    {
      "companyName": { "S": req.body.pCompany },
      "amountPaid": { "S": InvoiceAmountPaid },
      "collectionDate": { "S": InvoiceDate },
      "companyInvoiceNo": { "S": req.body.InvoiceNo },
      "staffName": { "S": req.body.InvoiceStaff }
    },
